...
class TestCreateP2pkhTransaction(unittest.TestCase):
    def setUp(self):
        ...
        self.sig_from_addr1 = Address('n4bkvTyU1dVdzsrhWBqBw8fEMbHjJvtmJR')
        self.sig_from_addr2 = Address('mmYNBho9BWQB2dSniP1NJvnPoj5EVWw89w')
        ...
        self.sig_to_addr1 = Address('myPAE9HwPeKHh8FjKwBNBaHnemApo3dw6e')
        self.sig_txout1 = TxOutput(0.09, ['OP_DUP', 'OP_HASH160', self.sig_to_addr1.to_hash160(), 'OP_EQUALVERIFY', 'OP_CHECKSIG'])
        self.sig_to_addr2 = Address('mmYNBho9BWQB2dSniP1NJvnPoj5EVWw89w')
        self.sig_txout2 = TxOutput(0.009, ['OP_DUP', 'OP_HASH160', self.sig_to_addr2.to_hash160(), 'OP_EQUALVERIFY', 'OP_CHECKSIG'])
    ...
    def test_signed_low_s_SIGSINGLE_tx_1_input_2_outputs(self):
        ...
        sig = self.sig_sk1.sign_input(tx, 0, ['OP_DUP', 'OP_HASH160',
                                         self.sig_from_addr1.to_hash160(),
                                         'OP_EQUALVERIFY', 'OP_CHECKSIG'],
                                 SIGHASH_SINGLE)
        pk = self.sig_sk1.get_public_key().to_hex()
        self.sig_txin1.script_sig = [sig, pk]
    ...
    def test_signed_SIGALL_tx_2in_2_out(self):
        ...
        sig = self.sig_sk1.sign_input(tx, 0, ['OP_DUP', 'OP_HASH160',
                                         ...
                                         'OP_EQUALVERIFY', 'OP_CHECKSIG'],
                                 SIGHASH_ALL)
        sig2 = self.sig_sk2.sign_input(tx, 1, ['OP_DUP', 'OP_HASH160',
        ...
        self.sig_txin1.script_sig = [sig, pk]
        self.sig_txin2.script_sig = [sig2, pk2]
