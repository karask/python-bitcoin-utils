...
class TestCreateP2wpkhTransaction(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.txout1 = TxOutput(to_satoshis(0.0099), self.p2wpkh_addr.to_script_pub_key())
        ...
        self.txout1_signone = TxOutput(to_satoshis(0.0080), self.p2pkh_addr.to_script_pub_key())
        self.txout2_signone = TxOutput(to_satoshis(0.0019), self.p2pkh_addr.to_script_pub_key())
        ...
        self.txout1_sigsingle = TxOutput(to_satoshis(0.01), self.p2pkh_addr.to_script_pub_key())
        self.txout2_sigsingle = TxOutput(to_satoshis(0.0092), self.p2pkh_addr.to_script_pub_key())
        ...
        self.txout1_siganyonecanpay_all = TxOutput(to_satoshis(0.0018), self.p2pkh_addr.to_script_pub_key())
        self.txout2_siganyonecanpay_all = TxOutput(to_satoshis(0.0017), self.p2pkh_addr.to_script_pub_key())
        ...
        self.txout1_siganyonecanpay_none = TxOutput(to_satoshis(0.008), self.p2pkh_addr.to_script_pub_key())
        self.txout2_siganyonecanpay_none = TxOutput(to_satoshis(0.007), self.p2pkh_addr.to_script_pub_key())
        ...
        self.txout1_siganyonecanpay_single = TxOutput(to_satoshis(0.005), self.p2pkh_addr.to_script_pub_key())
        self.txout2_siganyonecanpay_single = TxOutput(to_satoshis(0.0049), self.p2pkh_addr.to_script_pub_key())

        # result
        self.create_send_to_p2wpkh_result = ""
        ...
        self.test_signone_send_result = ""
        self.test_sigsingle_send_result = ""
        self.test_siganyonecanpay_all_send_result = ""
        self.test_siganyonecanpay_none_send_result = ""
    ...
    def test_siganyonecanpay_all_send(self):
        ...
        """
        tx = Transaction([self.txin1_siganyonecanpay_all],
    ...
    def test_siganyonecanpay_none_send(self):
        ...
        tx = Transaction([self.txin1_siganyonecanpay_none],
                         [self.txout1_siganyonecanpay_none], has_segwit=True)
        pk = self.sk.get_public_key().to_hex()
    ...
    def test_siganyonecanpay_single_send(self):
        ...
        """
        tx = Transaction([self.txin1_siganyonecanpay_single],
                         [self.txout1_siganyonecanpay_single], has_segwit=True)
        pk = self.sk.get_public_key().to_hex()
