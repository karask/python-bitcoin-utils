...
class TestCreateP2shTransaction(unittest.TestCase):
    def setUp(self):
        ...
        self.change_txout = TxOutput(to_satoshis(2), self.change_addr.to_script_pub_key())
        ...
        self.txout_spend = TxOutput(to_satoshis(0.8), self.change_addr.to_script_pub_key())
