...
class TestCreateP2trTransaction(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.scriptPubkey02 = Script(['OP_1', self.pub02.to_taproot_hex()]).to_hex()
        # same for 03
        ...
        self.raw_unsigned02 = '0200000001566e10098ddba743bedbe1e4b356377abb3ef106c6831e733863d5eea012647b0100000000ffffffff01a00f0000000000001976a9148e48a6c5108efac226d33018b5347bb24adec37a88ac00000000'
        ...
        self.amount02 = to_satoshis(0.00005)
        self.scriptPubkey03 = Script(['OP_1', self.pub03.to_taproot_hex()]).to_hex()

        self.raw_unsigned03 = '0200000001af13b1a8f3ed87c4a9424bd063f87d0ba3730031da90a3868a51a08bbdf8282a0100000000ffffffff01a00f0000000000001976a9148e48a6c5108efac226d33018b5347bb24adec37a88ac00000000'
