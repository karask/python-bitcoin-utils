...
class TestSignAndVerify(unittest.TestCase):
    def setUp(self):
        ...
        self.deterministic_signature = (
            "IEiQ7kHfGqlxHSOcUftzR4gChjupJbuIIJCiY3LryQ9SXwPeRoBtJYkrNd/rgU7RP9jX6i2IaGGYMLt9bW+/bbI="
        )
        self.external_signature = (
            "H+yEsMrKoLqcdegOxYbZ4MFpQkRJligl1whXQDY2+g7EptxmOj9vC3n5ykdHkof0qEbmyV62syaKh+9C95V5R34="
        )
    ...
    def test_verify_external(self):
        self.assertTrue(PublicKey.verify_message(self.external_address, self.external_signature, self.message))
