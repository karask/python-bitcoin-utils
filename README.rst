...
This is a very early version of the library (v0.1.1) and currently, it only supports private/public keys, addresses and creation of P2PKH and P2SH transactions (with all SIGHASH types). More functionality will be added continuously and the documentation will be improved as the work progresses.
