...
def main():
    ...
    sig = privkey_tr_script_A.sign_taproot_input(tx, 0, utxos_scriptPubkeys,
    ...
    tx.witnesses.append( TxWitnessInput([ sig, tr_script_p2pk_A.to_hex(), control_block.to_hex() ]) )
