...
def main():
    ...
    sig = privkey_tr_script.sign_taproot_input(tx, 0, utxos_scriptPubkeys, amounts,
    ...
    tx.witnesses.append( TxWitnessInput([ sig, tr_script_p2pk.to_hex(), control_block.to_hex() ]) )
