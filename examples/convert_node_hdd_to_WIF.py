...
def main():
    ...
    xprivkey = (
        "tprv8ZgxMBicQKsPekNkbvEF7XrgepZcUB4PpYtK3iHahuMitcp9kEPXQnXCbLr5BPc"
        "rwe1aYerGLEMpEpgvUNZEpSq5oD3snvLCJGSfJbw4AuD"
    )
    path = "m/44'/1'/0'/0/0"
    ...
    print("Derivation path:", path, " (default for legacy node addresses)")
    ...
    new_path = "m/84'/1'/0'/0/0"
    hdw.from_path(new_path)
    print("\n\nNew derivation path:", new_path, " (default for segwit node addresses)")
    ...
    print("\nFor nested segwit use path: m/49'/1'/0'/0/")
    print("\nFor taproot use path: m/86'/1'/0'/0/")
