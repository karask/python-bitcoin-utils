...
def main():
    ...
    txout = TxOutput( int(0.1 * COIN), Script(['OP_DUP', 'OP_HASH160', addr.to_hash160(),
    ...
    change_txout = TxOutput(int(0.29 * COIN), change_addr.to_script_pub_key())
    #change_txout = TxOutput(int(0.29 * COIN), Script(['OP_DUP', 'OP_HASH160',
