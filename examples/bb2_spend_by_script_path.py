...
def main():
    ...
    # TODO DELETE signature of taproot input's script - simple p2pk
    # TODO DELETE sig1 = privkey_tr_script.sign_input(tx, 0, tr_script_p2pk)
    # HOW TO SIGN maybe make a simple sign_schnorr for untweaked signing!!??!?!?!?
