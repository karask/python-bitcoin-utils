...
def main():
    ...
    tx_from_raw = Transaction.import_from_raw(tx.serialize())
    ...
    if tx_from_raw.serialize() == tx.serialize():
        print("SUCCESS import_from_raw Serialization OK")
    else:
        print("ERROR import_from_raw Serialization failed")

    if str(tx) == str(tx_from_raw):
        print("SUCCESS import_from_raw OK")
    else:
        print("ERROR import_from_raw failed")
    ...
    if tx_from_raw.serialize() == tx.serialize():
        print("SUCCESS signed import_from_raw Serialization OK")
    else:
        print("ERROR signed import_from_raw Serialization failed")

    if str(tx) == str(tx_from_raw):
        print("SUCCESS signed import_from_raw OK")
    else:
        print("ERROR signed import_from_raw failed")
